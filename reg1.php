			...
			<form action="reg1.php" method="POST" name="registration">
				<div class="fieldset_1">
					...
					<label class="label" for="sex">Пол:</label>
						<p>
							<label class="radio_name">Мужской<input type="radio" name="gender" value="male" checked></label>
							<label class="radio_name">Женский<input type="radio" name="gender" value="female"></label>
						</p>
				</div>
				...
				<div class="form_accept">
					...
					<label id="soglasie"><input type="checkbox" name="soglasie" required>Согласие на обработку персональных данных</label>
						<p><input type="submit" name="form_submit" alt="Отправить" class="submit_button_1 submit_button_1-reg" value="Зарегистрироваться"></p>
